...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 07.10.2021 à 14H s'est tenue une réunion avec Mr Faycel Fray du collègue Menzel jemil, et  Mr Samir le surveillant général pour la mise au point du calendrier des formations et workshops pour le groupe des élèves. Nos remerciements très chaleureux pour les élèves ainsi que le corps enseignant et les responsables de l'administration pour l'intérêt qu'ils ont témoigné pour la réussite de ce projet."
    }
  ];
