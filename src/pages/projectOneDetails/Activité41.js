...
const cards = [
    {   title: "Présentation",
        subtitle: "Dans le cadre du projet de sensibilisation et l'éducation environnementale cofinancé par l'UE, le 07.05.2022 ont été organisées les élections du bureau exécutif  du club de développement durable au collège Ibn Charaf  Menzel Bourguiba. Les résultats sont comme suit : Le Président : Mlle Achwak Touil. Le Vice Président : Mlle Takwa Bettaieb. Le Sécrétaire Général : Mr Omar Mejri. En présence de la Directrice du lycée Mme Houda Bakouri. Toutes nos félicitations pour les élus."
    }
  ];
