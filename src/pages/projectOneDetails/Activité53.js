...
const cards = [
    {   title: "Présentation",
        subtitle: "Dans le cadre du projet de sensibilisation et d'éducation environnementale cofinancé par l'UE , un atelier de formation a été organisé le 03.06.2022 au collège Menzel Jemil sur le thème de rédaction d'un article et le role du journalisme dans la sensibilisation et le changement des comportements en présence de Mr Lotfi Ben Maaoui président du CSPDD , Mme Faiza Labidi chef de projet . L'atelier a été animé par Mr Soufiane ben Rjab rédacteur en chef du journal Essabah. "
    }
  ];
