...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 19.11.2022 au lycée Ibn Sina Menzel Bourguiba, une séance avec le club de développement durable pour la préparation de l'activité de compostage en présence du chef de projet Dr Faiza Labidi, l'encadreur du club le professeur Mr Youssef Saidi et le président du CSPDD Mr Lotfi Ben Maaoui."
    }
  ];

let data = [];
for (let i = 188; i < 191; i++) {
    let photo = {};
