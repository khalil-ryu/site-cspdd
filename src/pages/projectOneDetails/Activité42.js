...
const cards = [
    {   title: "Présentation",
        subtitle: "Dans le cadre du projet de sensibilisation et d'éducation environnementale cofinancé par l'UE, le 07.05.2022 ont été organisées les élections du bureau exécutif  du club de développement durable au lycée Ibn Sina  Menzel Bourguiba. Les résultats sont comme suit : Le Président : Mlle Malek Bayaa Rassou. Le Vice Président : Mlle Souhir Eessid. Le Sécrétaire Général : Mr Amine Dhaouadi. En présence du professeur encadreur Mr Youssef Saidi. Toutes nos félicitations pour les élus."
    }
  ];
