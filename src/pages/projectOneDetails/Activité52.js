...
const cards = [
    {   title: "Présentation",
        subtitle: "La séance du 01.06.2022 au collège Ibn Charaf de Menzel Bourguiba en presence de la Directrice Mme Houda Baccouri Ep Jmili ,un atelier de formation sur les techniques de rédaction d'un article  animé par Mr Sofien Rajeb  directeur de la rédation  du journal Essabah. Les éleves ont  appris les étapes a suivre pour créer un bulettin d'information  sur les activités du club au sein de leur collège ."
    }
  ];

let data = [];
for (let i = 144; i < 147; i++) {
    let photo = {};
