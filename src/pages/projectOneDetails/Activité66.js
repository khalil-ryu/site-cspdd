...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 19.11.2022 la signature du contrat pour la réalisation du court métrage entre Mr Haythem Barguaoui le réalisateur et fondateur de la maison de l'art à Menzel Bourguiba, Mr Lotfi Ben Maaoui le président du CSPDD et en présence de Dr Faiza Labidi chef du projet et le professeur Mr Youssef Saidi encadreur du club de développement durable du lycée Ibn Sina Menzel Bourguiba."
    }
  ];

let data = [];
for (let i = 191; i < 194; i++) {
    let photo = {};
