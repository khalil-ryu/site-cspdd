...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 26.10.2022 une séance de porte ouverte pour les nouveaux adhérants au club de développement durable au lycée Menzel Jemil en présence de Mr Kais Mazhoudi,Mr Youssef Elghribi et les membres du club."
    }
  ];

let data = [];
for (let i = 182; i < 185; i++) {
    let photo = {};
