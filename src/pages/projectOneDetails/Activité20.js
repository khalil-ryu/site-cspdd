...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 16.10.2021 à 12h au Collège Ibn Charaf sous la direction de la nouvelle Directrice Mme Houda Kouri qui est très engagée pour la réussite du projet co financé  par l'UE. Des élèves très motivés pour apprendre sur leur environnement et leur Lac afin d'être de futurs citoyens actifs dans la préservation de la biodiversité et la promotion des objectifs du développement  durable. Mes remerciements à tous suite au bon déroulement de de cette séance ."
    }
  ];
