...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 6.10.2021 à 14 h On a poursuivi les activités du projet cofinancé par l'UE au lycée Menzel Jemil avec un groupe d'élèvs très motivés ,les futures piliers du developpement durable 2030 de leur ville et la protection de leur lac,en présence du Directeur Mr Kais Mazhoudi qui est le chef d'orchestre de la mise en œuvre du projet au sein de l'établissement."}
  ];
