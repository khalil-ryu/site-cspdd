...
const cards = [
    {   title: "Présentation",
        subtitle: "Il s'agit d'une action au niveau de l'infrastructure de l'école et la création d'un club de développement durable en milieu rural. Au niveau de l'école, nous avons pu contribuer à élaborer des travaux de peinture et de construction de quatorze fenêtres pour la protection des classes. D'autres activités sont programmées pour l'année 2022 au niveau de l'infrastructure et la création  d'un  club audio-visuel ainsi que la construction d'une cantine et d'une bibliothèque."}
  ];

let data = [];

let photo = {};
photo["imgSrc"] = '../../images/ecole.jpg'
data.unshift(photo);
