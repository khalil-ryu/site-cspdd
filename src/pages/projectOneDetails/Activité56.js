...
const cards = [
    {   title: "Présentation",
        subtitle: "Dans le cadre du projet de sensibilisation  et d'éducation environnementale cofinancé par l'UE, lancement le 06.07.2022 du club de cinéma à Menzel Bourguiba créé par les élèves du collège Ibn Charaf et lycée Ibn Sina. La première séance du groupe s'est tenue avec la formation sur les techniques de la photographie animée par le consulant Mr Haithem Bergaoui fondateur de la maison d'Art où a eu lieu la formation. La premiere séance c'est déroulée avec beaucoup d'enthousiasme et de convivialité."
    }
  ];
