...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 01.11.2022 au lycée Ibn Sina à Menzel Bouguiba ,une séance portes ouvertes pour les nouveaux adhérants du club de développement Durable en Présence du professeur et  encadreur Mr Youssef Saidi  ,Mme Nadia la surveillante génerale et le directeur du lycée Mr Rached toujours à l'écoute et à notre assistance  permanante."
    }
  ];

let data = [];
for (let i = 185; i < 188; i++) {
    let photo = {};
