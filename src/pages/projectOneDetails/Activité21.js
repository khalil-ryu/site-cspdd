...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 22.10.2021 à 13h au lycée Menzel jemil avec des élèves engagés pour poursuivre la formation de la pollution du projet cofinancé avec UE. Trois heures dans une ambiance agréable ,interactives avec  Dr Faiza Labidi la cheffe du projet qui a assuré cette formation ,en présence  du Président du CSPDD Mr Ben Maaoui Lotfi . Par la même occasion ,nos sincères remerciements pour Mr Kaies Mazhoudi pour son assistance et accompagnement pour la réussite du projet ."
    }
  ];
