...
const cards = [
    {   title: "Présentation",
        subtitle: "Le samedi 30.10.2021 dans le cadre du projet sur la sensibilisation et l'éducation environnementale cofinancé par l'UE,  a eu le formation sur la pollution au collège Ibn Charaf à Menzel Bourguiba avec Dr Faiza Labidi. 30 élèves et la directrice du collège, Mme Houda Baccouri, ont participé à cette formation avec beaucoup d'intérêt. Des interactions ont eu lieu entre participants et  formateur ce qui a permis une meilleure compréhension de la thématique. Cette formation sera achevée le 13.11.2021. Bravo à tous les élèves pour leur implication dans la formation !!"
    }
  ];
