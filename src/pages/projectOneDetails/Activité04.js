...
const cards = [
    {   title: "Présentation",
        subtitle: "Grâce à l'initiative de Dr Rabiaa Romdhane et du doyen de la FSEG Mahdia, Pr Faouzi Sboui, nous avons pu présenter un séminaire pour les étudiants de première année Master sous le thème : Le Développement Durable, Réalités et Perspectives."}
  ];

let data = [];

let photo = {};
photo["imgSrc"] = '../../images/seminaire.jpg'
data.unshift(photo);
