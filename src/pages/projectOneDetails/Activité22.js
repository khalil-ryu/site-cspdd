...
const cards = [
    {   title: "Présentation",
        subtitle: "Le 22.10.21 à 10 h du matin au collègue Menzel Jemil avec des collégiens et collégiennes qui ont adhérés pour suivre des formations du projet cofinancé avec l'UE, Mes remerciements pour l'assistance et l'engagement de Mr Faisel fray le directeur du collège ainsi que Mr Samir le surveillant général  et l'exceptionnel animateur Mr Moez."
    }
  ];
